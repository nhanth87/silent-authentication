...
class VerifyResourceTest {
    ...
    static class StubBootstrap implements SasVerifyEngine {
        VerifyResult result;
        ...
        @Override
        public InMemoryResolverBackend resolverBackend() {
            return new InMemoryResolverBackend();
        }
    }
    ...
    void setUp() throws Exception {
        ...
        resource.identityAnchor = failClosedAnchor();
    }
    ...
    private static IdentityAnchor failClosedAnchor() {
